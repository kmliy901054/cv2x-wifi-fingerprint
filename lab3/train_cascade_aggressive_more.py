"""Train 5 more seeds (47-51) of Cascade-aggressive.

Aggressive is the strongest individual variant and the dominant component of
the current best ensemble (0.699 m).  Doubling to 10 seeds should give a
more stable geom-median.
"""
import sys, time
...
# IDENTICAL to train_cascade_aggressive.py
